...
FROM 'C:\Users\debdamukherjee\Desktop\Power Bi Projects\credit_card.csv' 
with(
Fieldterminator=',',
rowterminator='\n',
firstrow=2);
...
FROM 'C:\Users\debdamukherjee\Desktop\Power Bi Projects\customer.csv' 
with(
Fieldterminator=',',
rowterminator='\n',
firstrow=2);
...
Bulk Insert cc_detail
FROM 'C:\Users\debdamukherjee\Desktop\Power Bi Projects\cc_add.csv' 
with(
Fieldterminator=',',
rowterminator='\n',
firstrow=2);
...
Bulk Insert cust_detail
FROM 'C:\Users\debdamukherjee\Desktop\Power Bi Projects\cust_add.csv' 
with(
Fieldterminator=',',
rowterminator='\n',
firstrow=2);
